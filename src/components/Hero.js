  ...
  <section className='bg-pink-200 min-h-[980px] bg-hero bg-cover bg-right'>
    ...
    <div className='container mx-auto min-h-[980px] flex justify-center items-center'>
      <motion.div variants={staggerContainer(0.3, 1)}
        ...
        <motion.div variants={fadeIn('down', 'tween', 0.2, 1.1)} className='text-white text-[24px] lg:text-[28px]
        font-primary italic lg:font-medium mb-1'>{pretitle}</motion.div>
        <motion.h1 variants={fadeIn('down', 'tween', 0.2, 1.3)} className='h1 mb-5'>{title}</motion.h1>
